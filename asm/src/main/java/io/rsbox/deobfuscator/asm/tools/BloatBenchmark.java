...
package io.rsbox.deobfuscator.asm.tools;

import java.io.*;
import java.util.*;

import io.rsbox.deobfuscator.asm.benchmark.*;
...
import io.rsbox.deobfuscator.asm.optimize.*;
...
import io.rsbox.deobfuscator.asm.benchmark.Times;
...
import io.rsbox.deobfuscator.asm.context.PersistentBloatContext;
...
import io.rsbox.deobfuscator.asm.inline.CallGraph;
import io.rsbox.deobfuscator.asm.inline.Inline;
import io.rsbox.deobfuscator.asm.inline.InlineStats;
import io.rsbox.deobfuscator.asm.inline.Specialize;
import io.rsbox.deobfuscator.asm.optimize.Main;
import io.rsbox.deobfuscator.asm.reflect.MethodInfo;
import io.rsbox.deobfuscator.asm.trans.Peephole;
...
public class BloatBenchmark {
	...
	private static void intraBloat(final Collection liveMethods,
		...
		for (int count = 0; iter.hasNext(); count++) {
			...
			try {
				Main.TRACE = BloatBenchmark.TRACE;
