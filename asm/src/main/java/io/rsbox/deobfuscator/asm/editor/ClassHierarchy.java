...
import io.rsbox.deobfuscator.asm.reflect.Constant;
...
import io.rsbox.deobfuscator.asm.util.Graph;
import io.rsbox.deobfuscator.asm.util.GraphNode;
...
public class ClassHierarchy {
	...
	private void addClass(final String name) {
		 ...
		 * 
		 * io.rsbox.deobfuscator.asm.depend.TypeNode typeNode =
