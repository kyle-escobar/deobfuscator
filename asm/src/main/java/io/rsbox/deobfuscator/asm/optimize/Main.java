...
package io.rsbox.deobfuscator.asm.optimize;
...
import io.rsbox.deobfuscator.asm.codegen.*;
import io.rsbox.deobfuscator.asm.context.*;
import io.rsbox.deobfuscator.asm.diva.*;
import io.rsbox.deobfuscator.asm.editor.*;
import io.rsbox.deobfuscator.asm.file.*;
import io.rsbox.deobfuscator.asm.inline.*;
import io.rsbox.deobfuscator.asm.reflect.*;
import io.rsbox.deobfuscator.asm.ssa.*;
import io.rsbox.deobfuscator.asm.tbaa.*;
import io.rsbox.deobfuscator.asm.trans.*;
import io.rsbox.deobfuscator.asm.tree.*;
import io.rsbox.deobfuscator.asm.cfg.DominatorTree;
import io.rsbox.deobfuscator.asm.cfg.FlowGraph;
import io.rsbox.deobfuscator.asm.cfg.VerifyCFG;
import io.rsbox.deobfuscator.asm.codegen.CodeGenerator;
import io.rsbox.deobfuscator.asm.codegen.Liveness;
import io.rsbox.deobfuscator.asm.codegen.RegisterAllocator;
...
import io.rsbox.deobfuscator.asm.editor.*;
import io.rsbox.deobfuscator.asm.file.ClassFile;
import io.rsbox.deobfuscator.asm.file.ClassFileLoader;
import io.rsbox.deobfuscator.asm.inline.StackHeightCounter;
import io.rsbox.deobfuscator.asm.reflect.ClassFormatException;
import io.rsbox.deobfuscator.asm.reflect.MethodInfo;
import io.rsbox.deobfuscator.asm.ssa.SSA;
import io.rsbox.deobfuscator.asm.ssa.SSAGraph;
import io.rsbox.deobfuscator.asm.tbaa.TypeInference;
import io.rsbox.deobfuscator.asm.trans.*;
import io.rsbox.deobfuscator.asm.tree.StackOptimizer;
import io.rsbox.deobfuscator.asm.tree.Tree;

/**
 * Usage: java Main [-options] classes dir
 * 
